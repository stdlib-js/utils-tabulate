...
```javascript
import tabulate from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-tabulate@v0.2.0-esm/index.mjs';
```
...
[@stdlib/utils/tabulate-by]: https://github.com/stdlib-js/utils-tabulate-by/tree/esm
